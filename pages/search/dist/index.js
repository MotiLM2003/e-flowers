...
var Search = function () {
    ...
    var onLifeFormChanged = function (value, isIn) {
        if (!isIn) {
            setState(__assign(__assign({}, state), { colors: state.life_forms.filter(function (x) { return x !== value; }) }));
        }
        else {
    ...
    var onSteamShapeChanged = function (value, isIn) {
        if (!isIn) {
            setState(__assign(__assign({}, state), { stem_shapes: state.stem_shapes.filter(function (x) { return x !== value; }) }));
        }
        else {
            var newForm = __spreadArrays(state.stem_shapes);
            newForm.push(value);
    ...
    var submitForm = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, userAPI_1["default"].post('/plants/search', state)];
                case 1:
                    data = (_a.sent()).data;
        ...
        react_1["default"].createElement("div", { className: 'default-container' },
            react_1["default"].createElement("div", { className: 'flex flex-col justify-center items-center' },
                        ...
                        react_1["default"].createElement("div", { className: 'grow-1' },
                            react_1["default"].createElement("div", { className: 'flex flex-col items-center justify-center my-5' },
                                ...
                                react_1["default"].createElement("div", { className: 'w-full text-center' },
                                    ...
                                    react_1["default"].createElement(MultipleChoice_1["default"], { list: leafShapeList, onChange: onSteamShapeChanged }),
                                    react_1["default"].createElement("p", { className: 'font-bold text-secondary text-center  border-b-4 border-b-primary my-2 text-md   \r\n\t\t\t\t\t\t\t\t\t\t' }, "\u05E7\u05D5\u05E6\u05D9\u05DD"),
                ...
                react_1["default"].createElement("div", { className: 'w-[90%] md:w-[30%] md:hover:w-[33%]  mt-1 md:mt-[3rem] rounded transition-all duration-500' },
                    react_1["default"].createElement("button", { className: 'bg-green p-2 w-full rounded hover:bg-dark-green hover:text-white  transition duration-1000', onClick: submitForm },
                        "\u05D7\u05D9\u05E4\u05D5\u05E9",
                        ' '))))));
};
