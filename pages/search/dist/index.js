            ...
            react_1["default"].createElement("div", { className: 'default-container' },
                react_1["default"].createElement("div", { className: 'flex flex-col justify-center items-center' },
                    ...
                    react_1["default"].createElement("div", { className: 'w-[90%] md:w-[30%] md:hover:w-[33%]  mt-1 md:mt-[3rem] rounded transition-all duration-500' },
                        react_1["default"].createElement("button", { className: 'bg-secondary  text-white p-2 w-full rounded  transition duration-1000', onClick: submitForm },
                            "\u05D7\u05D9\u05E4\u05D5\u05E9",
                            ' '))),
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("div", { className: 'flex flex-col' }, searchResults && (searchResults === null || searchResults === void 0 ? void 0 : searchResults.map(function (item, index) {
                        var currentId = index + 1;
                        return (react_1["default"].createElement(link_1["default"], { key: item.heb_name, href: '/' },
                            react_1["default"].createElement("div", { className: 'flex flex-col mb-5 cursor-pointer group' },
                                react_1["default"].createElement("div", { className: 'flex items-end gap-1 mb-2' },
                                    react_1["default"].createElement("span", { className: 'font-bold text-primary text-xl' }, currentId),
                                    react_1["default"].createElement("p", { className: 'font-bold text-secondary text-sm border-2  border-white border-b-secondary pb-[.5px8' }, item.heb_name)),
                                react_1["default"].createElement("div", { className: 'relative h-[100px] w-[100px] ' },
                                    react_1["default"].createElement(image_1["default"], { src: "https://storage.googleapis.com/ef-prod/plants-images/thumbnails/" + item.image, layout: 'fill', width: 100, height: 100, alt: "" + item.heb_name, className: 'rounded-xl ' })))));
                    }))))))));
};
