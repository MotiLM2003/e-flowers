        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, serverAPI_1["default"].post('/plants/search/', searchFilters)];
                case 2:
                    data = (_a.sent()).data;
                ...
                case 3:
                    ...
                    return [2 /*return*/, res.status(err_1.statusCode).json({ error: err_1 })];
