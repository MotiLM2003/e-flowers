...
var SearchCard = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: 'flex flex-col   w-full sm:w-[20rem]    my-4 \r\n          bg-white rounded-xl transform transition-all hover:-translate-y-[0.5px] shadow hover:shadow-xl\r\n          duration-300 pb-3 group' },
        react_1["default"].createElement("img", { src: "https://storage.googleapis.com/ef-prod/plants-images/thumbnails/" + item.image, className: 'h-40 object-cover rounded-xl w-full rounded-b-none', alt: 'some alt' }),
        react_1["default"].createElement("div", { className: 'p-2 flex flex-col justify-center gap-2' },
            ...
            react_1["default"].createElement("div", { className: 'flex items-center gap-4' },
                ...
                react_1["default"].createElement("p", { className: 'text-sm  text-secondary font-bold flex items-center gap-3' },
                    "\u05E6\u05D1\u05E2\u05D9\u05DD \u05D1\u05D8\u05D1\u05E2:",
                    react_1["default"].createElement("div", { className: 'flex gap-1 ' }, (_b = item.colors) === null || _b === void 0 ? void 0 : _b.map(function (color) {
        ...
        react_1["default"].createElement("div", { className: 'mt-2 self-center' },
            react_1["default"].createElement(link_1["default"], { role: 'button', href: "/plantes/" + item.science_name },
                react_1["default"].createElement("div", { className: 'text-white transform transition-all cursor-pointer duration-300  bg-gradient-to-t from-[#FFA500] to-[#FFD700] hover:from-[#FFD700] hover:to-[#FFA500] px-3 py-1 rounded-md ' }, "\u05D1\u05E7\u05E8 \u05D1\u05D3\u05E3 \u05D4\u05E6\u05DE\u05D7")))));
};
